...
def run_migrations_offline() -> None:
    ...
    """
    logger.info("Starting offline database migration...")
    try:
        ...
        logger.info("Offline database migration completed successfully.")
    except (OperationalError, ProgrammingError, IntegrityError, DataError) as e:
        logger.error("Database error during offline migration: %s", e, exc_info=True)
